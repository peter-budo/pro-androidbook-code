...
public class IntentUtils {
    ...
    public static void invokeBasicActivity(Activity activity) {
        String actionName = "uk.co.peterscorner.intent.action.ShowBasicView";
    ...
    public static void showMapAtLatLong(Activity activity) {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        //geo:lat,log?z=zoomlevel&q=question-string
    ...
    public static void parseResult(MainActivity activity, int requestCode, int resultCode, Intent outputIntent) {
        ...
        if (requestCode == 1) {
            parseResultForPick(activity, resultCode, outputIntent);
        } else if (requestCode == 2) {
            parseResultForContent(activity, resultCode, outputIntent);
        } else {
    ...
    public static void parseResultForPick(MainActivity activity, int resultCode, Intent outputIntent) {
    ...
    public static void parseResultForContent(MainActivity activity, int resultCode, Intent outputIntent) {
